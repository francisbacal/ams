        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header border-bottom">
                    <h3 class="card-title">Soft Deleted Category</h3>

                    <!--====== <Restore All> ======-->

                    {!! Form::open(['action'=>'CategoryController@restoreAll', 'method' => 'post', 'id' =>
                    'categoryRestoreAllForm', 'class'=>'mt-2']) !!}
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-striped table-valign-middle">
                        ...
                        @include('categories.partials.softdeleted', $categories)
